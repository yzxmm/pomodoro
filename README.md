...
## 7. 语音整理工具 (Voice Organizer)

本项目包含一个独立的语音整理工具，用于管理和识别音频文件。

- **位置**: `tools/voice_organizer.py`
- **功能**: 音频播放、文件分类、语音识别 (Whisper)。
- **配置指南**: 换机或初次使用前，请务必阅读 **[语音整理工具环境配置指南](tools/VOICE_ORGANIZER_SETUP.md)**，特别是 **FFmpeg** 的安装步骤。
